...
if (isset($_POST['Save']) && $getUser['level'] == 'ctv') {
    ...
    admin_msg_success("Lưu thành công", BASE_URL('ctv/history'), 500);
}
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control show-tick" name="status" required>
                                        ...
                                        <option value="nhandon" <?= $row['status'] == 'nhandon' ? 'selected' : ''; ?>>Đang reg
                                        </option>
                            ...
                            <a class="btn btn-danger btn-block" href="<?= BASE_URL('ctv/history'); ?>">
                                <span>TRỞ LẠI</span></a>
                        </form>
                    </div>
                </div>
