                ...
                <div class="login">
                    ...
                    <div class="login-wrapper">
                        <div class="login-body">
                            ...
                            <p class="login-desc">Quý khách quên mật khẩu ? Xin vui lòng điền địa chỉ Email vào ô dưới đây để yêu cầu lấy lại mật khẩu.</p>
                            <form class="login-form" method="post" role="form">
                                <div class="form-group">
                                    <label for="inputEmail">Địa chỉ email</label>
                                    <input type="text" class="form-control input-lg" id="email" placeholder="Nhập email" autofocus>
                                </div>
            ...
            $.ajax({
                ...
                success: function(respone) {
                    if (respone.status == 'success') {
                        ...
                        setTimeout("location.href = '<?= BASE_URL('client/recovery-authentication'); ?>';", 2000);
                    } else {
                        cuteToast({
                            type: "error",
                            message: respone.msg,
