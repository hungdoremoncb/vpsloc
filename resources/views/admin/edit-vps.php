...
{
    $row = $NNL->get_row(" SELECT * FROM `category_vps` WHERE `id` = '".check_string($_GET['id'])."'  ");
    if(!$row)
    {
...
if(isset($_POST['LuuVps']) && $getUser['level'] == 'admin' )
{
                ...
                <div class="card-header">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <a class="btn btn-danger btn-block" href="<?=BASE_URL('admin/vps');?>">
                                <span>TRỞ LẠI</span></a>
                        </form>
                    </div>
                </div>
